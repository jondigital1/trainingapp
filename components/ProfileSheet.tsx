  ...
  return (
    ...
    >
      ...
      <div className="mt-5">
        ...
        {section === 'record' ? <Record workouts={workouts} days={draft.days ?? 3} /> : null}
...
// a target and nothing here goes down, which is the point of putting it on the
// profile rather than the log tab.
function Record({ workouts, days }: { workouts: Workout[]; days: number }) {
