...
const RAW: Record<string, string[]> = {
  ...
  Hamstrings: [
    'Romanian Deadlift|W|Glutes',
    'Dumbbell Romanian Deadlift|W|Glutes',
    'Single Leg Romanian Deadlift|W|Glutes',
    ...
    'Deficit Deadlift|W',
    'Snatch Grip Romanian Deadlift|W|Glutes',
    'B-Stance Romanian Deadlift|W|Glutes',
    'Kettlebell Swing|W',
